...
export default function Home() {
		...
		setFaqData([
			{
				...
				faqs: [
					...
					},
					{
						...
						answer: (<><p>{translate1('faqQuestions4Answer1')} </p><p>{translate1.rich('faqQuestions4Answer2', { email: (chunks: string) => (<a href="mailto:hi@SEOKart.com">{chunks}</a>)})}</p></>),
						visible: true,
						toggleOpen: false
					}
				]
	...
	// console.log("translate('general')>>>>>>>>>>>>", translate('general'));
